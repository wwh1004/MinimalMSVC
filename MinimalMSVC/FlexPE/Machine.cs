...
partial class Extensions {
	...
	/// <returns></returns>
	/// <remarks>
	/// Do NOT call this method to check PE file is 64bit for .NET assembly. Use <see cref="OptionalHeader.IsPE64"/> instead.
	/// <see cref="FileHeader.Machine"/> of a .NET AnyCPU assembly loaded into x64 process is still <see cref="Machine.I386"/>
	/// </remarks>
